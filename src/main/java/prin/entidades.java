...
public class entidades extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Datos.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Tabla Entidades", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 24))); // NOI18N
        ...
        DatosLayout.setHorizontalGroup(
            ...
            .addGroup(DatosLayout.createSequentialGroup()
                ...
                .addGap(60, 60, 60)
                .addGroup(DatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(edad, javax.swing.GroupLayout.DEFAULT_SIZE, 313, Short.MAX_VALUE)
    ...
    void consultar(){
        String sql = "select * FROM inegi2020.entidades";
        ...
        try{
            ...
            while (rs.next()){
                cliente[0] = rs.getInt("identidades");
                cliente [1] = rs.getString("nom_entidad");
